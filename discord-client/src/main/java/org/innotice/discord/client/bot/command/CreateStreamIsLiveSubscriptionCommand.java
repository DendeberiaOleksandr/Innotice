...
public class CreateStreamIsLiveSubscriptionCommand extends AbstractStreamIsLiveSubscriptionCommand {
    ...
    public Mono<Void> execute() {
        return secretWebClient.post()
                ...
                .body(new DiscordServer(getDiscordServerId(), Set.of(new StreamerIsLiveSubscription(getStreamerId(), getStreamerName(), getDiscordChatId())), LocalDateTime.now()), DiscordServer.class)
                .retrieve()
